...
def telegram_bot():
    ...
    if "message" in data:
        ...
        # Kunin ang Telegram username (o ID kung walang username)
        ...
        # KAPAG NAG-/START SILA (Deep Link na may kasamang device id)
        if msg_text.startswith("/start"):
            ...
            # Eksaktong "Success!" lang ang isasagot ng bot ayon sa gusto mo
            reply_text = "Success!"
